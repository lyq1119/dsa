...
![alt text](截屏2026-03-12%2022.27.51.png)
...
数字华容道没有想到用逆序对www，以前搞竞赛的时候组合还是学的太差了，最后是被同学提示后意识到逆序对这事后遂做出
由于这周比较忙，没有刷其他的题，只是把讲义做了一下（做讲义才发现原来华容道的tag就是暗示逆序对（www没看到tag）